    ...
    advanceText(index){
        ...
        if (this.battleCounter==0){
            ...
            if(index==2)
            {
                ...
                .setColor('#FFF111')
                .setInteractive()
                .on('pointerdown', () => this.scene.start('WorldScene',{id:this.battleCounter,bool: true}));
            }
        }
        //end of text 1
        if (this.battleCounter==1){
                ...
                if(index==1)
                {
                    this.worldText = this.add.text(50, 120, ['I definetly saw an Anxiety Elf fade off out of the cloud.'])
                    .setFontSize(30)
                    .setFontFamily('Copperplate')
                    .setColor('#FFFFFF') 
                }
                if(index==2)
                {
                    this.worldText = this.add.text(50, 170, ['They place spells that create feelings of fear, dread, and uneasiness.'])
                    .setFontSize(40)
                    .setFontFamily('Copperplate')
                    .setColor('#FFFFFF')  
                }
                ...
                if (index==4)
                {
                    this.worldText = this.add.text(50, 285,['It is important to be able to handle how Anxiety Elfs'])
                    .setFontSize(30)
                    .setFontFamily('Copperplate')
                    .setColor('#FFFFFF')  
        ...
        if (this.battleCounter==2){
            ...
            if(index==2)
            {
                ...
                .setFontFamily('Copperplate')
                .setColor('#FFFFFF')  
                this.worldText = this.add.text(50, 220, ['and always take more than they need'])
                .setFontSize(40)
                .setFontFamily('Copperplate')
                .setColor('#FFFFFF')  
            }
            if (index==3)
            {
                this.worldText = this.add.text(50, 280, ['These creatures are less common and quite disliked by people'])
                .setFontSize(30)
                .setFontFamily('Copperplate')
                .setColor('#FFFFFF')  
            }
